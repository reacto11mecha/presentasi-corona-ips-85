...
function errorHandlerFetchChart(type, error) {
  ...
  p.innerHTML = "Ada kesalahan dalam menampilkan bagan | Error : <span style=\"color: red;\">".concat(error, "</span>");
...
fetch("https://api.kawalcorona.com/indonesia/").then(function (res) {
  ...
  var bukanContainer = document.querySelector(".content-center#angkaCorona");
  var h2 = document.createElement("h2");
  h2.classList.add("osans-bold");
  h2.innerHTML = "Mohon Maaf";
  var h3 = document.createElement("h3");
  ...
  var p = document.createElement("p");
  p.classList.add("osans");
  p.innerHTML = "Ada kesalahan dalam menampilkan data | Error : <span style=\"color: red;\">".concat(error, "</span>");
