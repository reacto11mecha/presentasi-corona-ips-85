...
__webpack_require__.e(/* import() */ 289).then(__webpack_require__.t.bind(__webpack_require__, 289, 23)).then(() => {
...
__webpack_require__.e(/* import() */ 337).then(__webpack_require__.t.bind(__webpack_require__, 337, 23)).then(async () => {
  const errorFetch = await __webpack_require__.e(/* import() */ 249).then(__webpack_require__.bind(__webpack_require__, 249)).then(
    (mod) => mod.errorHandlerFetchChart
  );
  const typeChart = await __webpack_require__.e(/* import() */ 181).then(__webpack_require__.bind(__webpack_require__, 181)).then((mod) => mod.typeChart);

  const observerChart1 = new IntersectionObserver(async (entries) => {
    if (entries[0].isIntersecting) {
      const fetcher = await __webpack_require__.e(/* import() */ 327).then(__webpack_require__.bind(__webpack_require__, 327)).then((mod) => mod.fetcher);
      ...
      fetcher(
        ...
        .then(async (result) => {
          ...
          const Chart = await __webpack_require__.e(/* import() */ 757).then(__webpack_require__.t.bind(__webpack_require__, 757, 23)).then((mod) => mod.default);
...
/******/ 			if (chunkId === 532) return "styles.css";
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "ppt-ips-coronavirus-85:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkppt_ips_coronavirus_85"] = self["webpackChunkppt_ips_coronavirus_85"] || [];
